...
{
    this.powerup.set(Math.random() * (this.BOUNDARY_WIDTH - 10 * this.POWERUP_RADIUS) + 5 * this.POWERUP_RADIUS, 
                    Math.random() * (this.BOUNDARY_HEIGHT - 10 * this.POWERUP_RADIUS) + 5 * this.POWERUP_RADIUS);
}
